...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0004R.styleable.TextInputLayout_passwordToggleTintMode)) {
            ...
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0004R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
        a.recycle();
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0269R.style.TextAppearance_AppCompat_Caption);
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0269R.style.TextAppearance_AppCompat_Caption);

...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0004R.styleable.NavigationView_itemTextColor)) {
            itemTextColor = a.getColorStateList(C0004R.styleable.NavigationView_itemTextColor);
        }
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0269R.attr.colorPrimary, value, true)) {
            return null;
        }

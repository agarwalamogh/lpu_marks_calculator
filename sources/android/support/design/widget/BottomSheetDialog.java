...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        CoordinatorLayout coordinator = (CoordinatorLayout) View.inflate(getContext(), C0004R.layout.design_bottom_sheet_dialog, null);
        ...
        coordinator.findViewById(C0004R.C0006id.touch_outside).setOnClickListener(new OnClickListener() {

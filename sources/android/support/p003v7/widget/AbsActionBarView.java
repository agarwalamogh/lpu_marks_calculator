...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0269R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0269R.styleable.ActionBar, C0269R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0269R.styleable.ActionBar_height, 0));
        a.recycle();

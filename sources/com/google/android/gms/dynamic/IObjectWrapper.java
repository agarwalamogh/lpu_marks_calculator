...
public interface IObjectWrapper extends IInterface {
    ...
    public static abstract class zza extends Binder implements IObjectWrapper {
        ...
        private static class C0942zza implements IObjectWrapper {
            private IBinder zzrk;

            C0942zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static IObjectWrapper zzcd(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IObjectWrapper)) ? new C0942zza(iBinder) : (IObjectWrapper) queryLocalInterface;
        }

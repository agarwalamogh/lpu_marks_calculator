...
public interface zzhl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhl {
        ...
        private static class C0985zza implements zzhl {
            private IBinder zzrk;

            C0985zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhl zzF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhl)) ? new C0985zza(iBinder) : (zzhl) queryLocalInterface;
        }

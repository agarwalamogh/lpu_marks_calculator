...
public class zzfo extends zza {
    ...
    public void zza(zzoa zzoa) throws RemoteException {
        zzqf.m31e("This app is using a lightweight version of the Google Mobile Ads SDK that requires the latest Google Play services to be installed, but Google Play services is either missing or out of date.");

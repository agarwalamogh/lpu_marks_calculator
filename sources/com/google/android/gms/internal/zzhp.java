...
public interface zzhp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhp {
        ...
        private static class C0987zza implements zzhp {
            private IBinder zzrk;

            C0987zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhp zzH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhp)) ? new C0987zza(iBinder) : (zzhp) queryLocalInterface;
        }

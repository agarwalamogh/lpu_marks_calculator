...
public interface zzke extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzke {
        ...
        private static class C0995zza implements zzke {
            private IBinder zzrk;

            C0995zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzke zzQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzke)) ? new C0995zza(iBinder) : (zzke) queryLocalInterface;
        }

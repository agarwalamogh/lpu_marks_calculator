...
public interface zzla extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzla {
        ...
        private static class C0998zza implements zzla {
            private IBinder zzrk;

            C0998zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzla zzU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzla)) ? new C0998zza(iBinder) : (zzla) queryLocalInterface;
        }

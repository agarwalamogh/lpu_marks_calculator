...
public interface zzet extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzet {
        ...
        private static class C0970zza implements zzet {
            private IBinder zzrk;

            C0970zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzet zzq(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzet)) ? new C0970zza(iBinder) : (zzet) queryLocalInterface;
        }

...
public interface zzom extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzom {
        ...
        private static class C1011zza implements zzom {
            private IBinder zzrk;

            C1011zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzom zzal(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzom)) ? new C1011zza(iBinder) : (zzom) queryLocalInterface;
        }

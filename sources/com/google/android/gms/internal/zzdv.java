...
public interface zzdv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdv {
        ...
        private static class C0964zza implements zzdv {
            private IBinder zzrk;

            C0964zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzdv zzi(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdv)) ? new C0964zza(iBinder) : (zzdv) queryLocalInterface;
        }

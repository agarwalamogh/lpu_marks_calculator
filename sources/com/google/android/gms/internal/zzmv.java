...
public final class zzmv extends zza {
    ...
    public <T extends SafeParcelable> T zza(Creator<T> creator) {
        if (this.zzSS) {
            if (this.zzSQ == null) {
                zzpk.m31e("File descriptor is empty, returning null.");
                return null;
            }
                ...
                new Thread(new Runnable(this) {
                    ...
                    public void run() {
                        ...
                        L_0x0043:
                            ...
                            goto L_0x0019
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzmv.C08111.run():void");
                    }
                }).start();
                return createPipe[0];
            } catch (IOException e) {

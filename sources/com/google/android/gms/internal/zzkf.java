...
public interface zzkf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkf {
        ...
        private static class C0996zza implements zzkf {
            private IBinder zzrk;

            C0996zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzkf zzR(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkf)) ? new C0996zza(iBinder) : (zzkf) queryLocalInterface;
        }

...
public interface zzeo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeo {
        ...
        private static class C0965zza implements zzeo {
            private IBinder zzrk;

            C0965zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzeo zzl(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeo)) ? new C0965zza(iBinder) : (zzeo) queryLocalInterface;
        }

...
final class zzao {
    ...
    static byte[] zzb(String str, String str2, boolean z, boolean z2) {
        ...
        try {
            ...
            byte[] bytes = z ? str2.length() < 3 ? str2.getBytes("ISO-8859-1") : zzam.zza(str2, true) : (str2 == null || str2.length() == 0) ? Integer.toString(5).getBytes("ISO-8859-1") : zzam.zza(zza(str2.getBytes("ISO-8859-1"), (String) null, z2), true);
            zzc.zzcu = bytes;

...
public interface zzbxy {
    ...
    public static final class zza extends zzbxn<zza> implements Cloneable {
        ...
        public int hashCode() {
            return ((this.zzcuI == null || this.zzcuI.isEmpty()) ? 0 : this.zzcuI.hashCode()) + ((((((((((((getClass().getName().hashCode() + 527) * 31) + zzbxr.hashCode((Object[]) this.zzcvg)) * 31) + zzbxr.hashCode((Object[]) this.zzcvh)) * 31) + zzbxr.hashCode(this.zzcvi)) * 31) + zzbxr.hashCode(this.zzcvj)) * 31) + zzbxr.hashCode(this.zzcvk)) * 31);
        }
            ...
            while (true) {
                ...
                switch (zzaeo) {
                    ...
                    case 40:
                        ...
                        continue;
                    case 42:
                        int zzra3 = zzbxl.zzra(zzbxl.zzaex());
        ...
        public int zzu() {
            ...
            return i + i8 + (this.zzcvk.length * 1);
        }
    }
    ...
    public static final class zzd extends zzbxn<zzd> implements Cloneable {
                ...
                if (this.zzcvv != null && this.zzcvv.length > 0) {
                    ...
                    while (true) {
                        ...
                        if (this.zzcvv[i2] != null) {
                            zzd.zzcvv[i2] = (zze) this.zzcvv[i2].clone();
                        }
                        i = i2 + 1;
                    }
                }
        ...
        public int zzu() {
            ...
            if (this.zzcvI != null && this.zzcvI.length > 0) {
                ...
                zzu = zzu + i2 + (this.zzcvI.length * 2);
            }
            if (this.zzcvt != 0) {

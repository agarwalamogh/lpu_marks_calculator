...
public interface zzaqm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaqm {
        ...
        private static class C0957zza implements zzaqm {
            private IBinder zzrk;

            C0957zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzaqm zzcU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaqm)) ? new C0957zza(iBinder) : (zzaqm) queryLocalInterface;
        }

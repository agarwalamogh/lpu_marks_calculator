...
public interface zzmu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmu {
        ...
        private static class C1006zza implements zzmu {
            private IBinder zzrk;

            C1006zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzmu zzaf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmu)) ? new C1006zza(iBinder) : (zzmu) queryLocalInterface;
        }

...
public interface zzkc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkc {
        ...
        private static class C0993zza implements zzkc {
            private IBinder zzrk;

            C0993zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzkc zzO(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkc)) ? new C0993zza(iBinder) : (zzkc) queryLocalInterface;
        }

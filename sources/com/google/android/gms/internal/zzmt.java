...
public interface zzmt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmt {
        ...
        private static class C1005zza implements zzmt {
            private IBinder zzrk;

            C1005zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzmt zzae(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmt)) ? new C1005zza(iBinder) : (zzmt) queryLocalInterface;
        }

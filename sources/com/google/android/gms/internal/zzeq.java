...
public interface zzeq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeq {
        ...
        private static class C0967zza implements zzeq {
            private IBinder zzrk;

            C0967zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzeq zzn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeq)) ? new C0967zza(iBinder) : (zzeq) queryLocalInterface;
        }

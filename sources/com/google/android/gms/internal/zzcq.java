...
public interface zzcq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcq {
        ...
        private static class C0963zza implements zzcq {
            private IBinder zzrk;

            C0963zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzcq zzf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcq)) ? new C0963zza(iBinder) : (zzcq) queryLocalInterface;
        }

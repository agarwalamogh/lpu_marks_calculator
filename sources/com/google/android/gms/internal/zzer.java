...
public interface zzer extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzer {
        ...
        private static class C0968zza implements zzer {
            private IBinder zzrk;

            C0968zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzer zzo(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzer)) ? new C0968zza(iBinder) : (zzer) queryLocalInterface;
        }

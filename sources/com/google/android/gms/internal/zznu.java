...
public interface zznu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznu {
        ...
        private static class C1008zza implements zznu {
            private IBinder zzrk;

            C1008zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zznu zzah(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznu)) ? new C1008zza(iBinder) : (zznu) queryLocalInterface;
        }

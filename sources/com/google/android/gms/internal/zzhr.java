...
public interface zzhr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhr {
        ...
        private static class C0989zza implements zzhr {
            private IBinder zzrk;

            C0989zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhr zzJ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhr)) ? new C0989zza(iBinder) : (zzhr) queryLocalInterface;
        }

...
public interface zzev extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzev {
        ...
        private static class C0972zza implements zzev {
            private IBinder zzrk;

            C0972zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzev zzs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzev)) ? new C0972zza(iBinder) : (zzev) queryLocalInterface;
        }

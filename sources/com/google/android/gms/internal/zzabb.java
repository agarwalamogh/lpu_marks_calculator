...
public interface zzabb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzabb {
        ...
        private static class C0951zza implements zzabb {
            private IBinder zzrk;

            C0951zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzabb zzbp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzabb)) ? new C0951zza(iBinder) : (zzabb) queryLocalInterface;
        }

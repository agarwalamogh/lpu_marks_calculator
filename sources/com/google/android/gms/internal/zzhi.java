...
public interface zzhi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhi {
        ...
        private static class C0983zza implements zzhi {
            private IBinder zzrk;

            C0983zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhi zzD(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhi)) ? new C0983zza(iBinder) : (zzhi) queryLocalInterface;
        }

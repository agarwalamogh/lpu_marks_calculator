...
public class zzek {
    ...
    private static boolean zza(Activity activity, String str) {
        ...
        zzqf.m31e("useClientJar flag not found in activity intent extras.");
        return false;
    }
    ...
    public zzet zza(final Context context, final zzeg zzeg, final String str) {
        return (zzet) zza(context, false, (zza<T>) new zza<zzet>() {
            ...
            public zzet zzb(zzew zzew) throws RemoteException {
                return zzew.createSearchAdManager(zzd.zzA(context), zzeg, str, 10240000);
            }
            ...
            public zzet zzeJ() {
                ...
                zzek.this.zzc(context, Event.SEARCH);
                return new zzfl();
            }
        });
    }
    ...
    public zzet zza(Context context, zzeg zzeg, String str, zzka zzka) {
        ...
        return (zzet) zza(context, false, (zza<T>) new zza<zzet>() {
            /* renamed from: zza */
            public zzet zzb(zzew zzew) throws RemoteException {
                return zzew.createBannerAdManager(zzd.zzA(context2), zzeg2, str2, zzka2, 10240000);
            }
    ...
    public zzhh zza(final Context context, final FrameLayout frameLayout, final FrameLayout frameLayout2) {
        return (zzhh) zza(context, false, (zza<T>) new zza<zzhh>() {
            /* renamed from: zze */
    ...
    public zznu zza(final Context context, final zzka zzka) {
        return (zznu) zza(context, false, (zza<T>) new zza<zznu>() {
            /* renamed from: zzeN */
            public zznu zzeJ() {
            ...
            public zznu zzb(zzew zzew) throws RemoteException {
                return zzew.createRewardedVideoAd(zzd.zzA(context), zzka, 10240000);
            }
        });
    }
    ...
    public zzer zzb(final Context context, final String str, final zzka zzka) {
        return (zzer) zza(context, false, (zza<T>) new zza<zzer>() {
            ...
            public zzer zzb(zzew zzew) throws RemoteException {
                return zzew.createAdLoaderBuilder(zzd.zzA(context), str, zzka, 10240000);
            }
    ...
    public zzet zzb(Context context, zzeg zzeg, String str, zzka zzka) {
        ...
        return (zzet) zza(context, false, (zza<T>) new zza<zzet>() {
            /* renamed from: zza */
            public zzet zzb(zzew zzew) throws RemoteException {
                return zzew.createInterstitialAdManager(zzd.zzA(context2), zzeg2, str2, zzka2, 10240000);
            }
    ...
    public zzey zzl(final Context context) {
        return (zzey) zza(context, false, (zza<T>) new zza<zzey>() {
            /* renamed from: zzd */
            public zzey zzb(zzew zzew) throws RemoteException {
                return zzew.getMobileAdsSettingsManagerWithClientJarVersion(zzd.zzA(context), 10240000);
            }

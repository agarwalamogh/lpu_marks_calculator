...
public interface zzlf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlf {
        ...
        private static class C1001zza implements zzlf {
            private IBinder zzrk;

            C1001zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzlf zzY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlf)) ? new C1001zza(iBinder) : (zzlf) queryLocalInterface;
        }

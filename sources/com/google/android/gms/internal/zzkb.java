...
public interface zzkb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkb {
        ...
        private static class C0992zza implements zzkb {
            private IBinder zzrk;

            C0992zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzkb zzN(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkb)) ? new C0992zza(iBinder) : (zzkb) queryLocalInterface;
        }

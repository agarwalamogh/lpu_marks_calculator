...
public interface zzey extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzey {
        ...
        private static class C0975zza implements zzey {
            private IBinder zzrk;

            C0975zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzey zzu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzey)) ? new C0975zza(iBinder) : (zzey) queryLocalInterface;
        }

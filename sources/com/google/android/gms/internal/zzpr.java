...
public class zzpr {
    ...
    private void zzkU() {
        ...
        String str = resources != null ? resources.getString(C0391R.string.debug_menu_title) : "Select a Debug Mode";
        String str2 = resources != null ? resources.getString(C0391R.string.debug_menu_ad_information) : "Ad Information";
        String str3 = resources != null ? resources.getString(C0391R.string.debug_menu_creative_preview) : "Creative Preview";
        String str4 = resources != null ? resources.getString(C0391R.string.debug_menu_troubleshooting) : "Troubleshooting";

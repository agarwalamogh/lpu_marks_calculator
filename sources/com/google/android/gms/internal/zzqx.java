...
public class zzqx extends WebViewClient {
    ...
    public final void onLoadResource(WebView webView, String str) {
        ...
        zzpk.m30v(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2));
        Uri parse = Uri.parse(str);
    ...
    public void zzj(Uri uri) {
        ...
        if (list != null) {
            ...
            if (zzpk.zzak(2)) {
                ...
                for (String str2 : zzg.keySet()) {
                    ...
                    zzpk.m30v(new StringBuilder(String.valueOf(str2).length() + 4 + String.valueOf(str3).length()).append("  ").append(str2).append(": ").append(str3).toString());
                }
            }
            for (zzid zza2 : list) {
        ...
        zzpk.m30v(new StringBuilder(String.valueOf(valueOf2).length() + 32).append("No GMSG handler found for GMSG: ").append(valueOf2).toString());
    }
    ...
    public void zzlS() {
        synchronized (this.zzrJ) {
            zzpk.m30v("Loading blank page in WebView, 2...");
            this.zzZL = true;

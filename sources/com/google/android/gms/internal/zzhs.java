...
public interface zzhs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhs {
        ...
        private static class C0990zza implements zzhs {
            private IBinder zzrk;

            C0990zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhs zzK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhs)) ? new C0990zza(iBinder) : (zzhs) queryLocalInterface;
        }

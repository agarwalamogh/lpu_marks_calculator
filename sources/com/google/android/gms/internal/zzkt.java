    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                zzM.setTitle(resources != null ? resources.getString(C0391R.string.store_picture_title) : "Save image");
                zzM.setMessage(resources != null ? resources.getString(C0391R.string.store_picture_message) : "Allow Ad to store image in Picture gallery?");

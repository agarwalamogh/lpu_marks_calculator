...
public interface zzhq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhq {
        ...
        private static class C0988zza implements zzhq {
            private IBinder zzrk;

            C0988zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhq zzI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhq)) ? new C0988zza(iBinder) : (zzhq) queryLocalInterface;
        }

...
public interface zzack extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzack {
        ...
        private static class C0953zza implements zzack {
            private IBinder zzrk;

            C0953zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzack zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzack)) ? new C0953zza(iBinder) : (zzack) queryLocalInterface;
        }

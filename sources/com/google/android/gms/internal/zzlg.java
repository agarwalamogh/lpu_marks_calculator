...
public interface zzlg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlg {
        ...
        private static class C1002zza implements zzlg {
            private IBinder zzrk;

            C1002zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzlg zzZ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlg)) ? new C1002zza(iBinder) : (zzlg) queryLocalInterface;
        }

...
public interface zzkz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkz {
        ...
        private static class C0997zza implements zzkz {
            private IBinder zzrk;

            C0997zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzkz zzT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkz)) ? new C0997zza(iBinder) : (zzkz) queryLocalInterface;
        }

...
public interface zzld extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzld {
        ...
        private static class C0999zza implements zzld {
            private IBinder zzrk;

            C0999zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzld zzW(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzld)) ? new C0999zza(iBinder) : (zzld) queryLocalInterface;
        }

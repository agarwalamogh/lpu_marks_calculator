...
public class zzhb implements zzha {
            ...
            return new zzid() {
                public void zza(zzqw zzqw, final Map<String, String> map) {
                    ...
                    if (TextUtils.isEmpty(str2)) {
                        ...
                        zzqw2.loadDataWithBaseURL(str2, str, "text/html", "UTF-8", null);
                    }
                }
            };
        }
    ...
    public zzhb(Context context, zzs zzs, @Nullable zzlw zzlw, zzaw zzaw, @Nullable JSONObject jSONObject, @Nullable com.google.android.gms.internal.zzha.zza zza2, @Nullable zzqh zzqh, @Nullable String str) {

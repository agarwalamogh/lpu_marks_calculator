...
public interface zzzs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzzs {
        ...
        private static class C1014zza implements zzzs {
            private IBinder zzrk;

            C1014zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzzs zzbo(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzzs)) ? new C1014zza(iBinder) : (zzzs) queryLocalInterface;
        }

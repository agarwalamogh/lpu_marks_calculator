...
public interface zzauu {
    ...
    public static final class zza extends zzbxn<zza> {
        ...
        public int hashCode() {
            int i = 0;
            int hashCode = ((((((this.zzbwk == null ? 0 : this.zzbwk.hashCode()) + ((getClass().getName().hashCode() + 527) * 31)) * 31) + zzbxr.hashCode((Object[]) this.zzbwl)) * 31) + zzbxr.hashCode((Object[]) this.zzbwm)) * 31;
    ...
    public static final class zzb extends zzbxn<zzb> {
        ...
        public int hashCode() {
            int i = 0;
            int hashCode = ((this.zzbws == null ? 0 : this.zzbws.hashCode()) + (((this.zzbwr == null ? 0 : this.zzbwr.hashCode()) + (((((this.zzbwp == null ? 0 : this.zzbwp.hashCode()) + (((this.zzbwo == null ? 0 : this.zzbwo.hashCode()) + ((getClass().getName().hashCode() + 527) * 31)) * 31)) * 31) + zzbxr.hashCode((Object[]) this.zzbwq)) * 31)) * 31)) * 31;
            if (this.zzcuI != null && !this.zzcuI.isEmpty()) {
                i = this.zzcuI.hashCode();
            }
            return hashCode + i;
    ...
    public static final class zzf extends zzbxn<zzf> {
        ...
        public int hashCode() {
            int i = 0;
            int hashCode = ((((this.zzbwI == null ? 0 : this.zzbwI.hashCode()) + (((this.zzbwH == null ? 0 : this.zzbwH.hashCode()) + (((this.zzbwG == null ? 0 : this.zzbwG.intValue()) + ((getClass().getName().hashCode() + 527) * 31)) * 31)) * 31)) * 31) + zzbxr.hashCode((Object[]) this.zzbwJ)) * 31;
            if (this.zzcuI != null && !this.zzcuI.isEmpty()) {
                i = this.zzcuI.hashCode();
            }
            return hashCode + i;

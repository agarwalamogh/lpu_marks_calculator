...
public interface zzka extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzka {
        ...
        private static class C0991zza implements zzka {
            private IBinder zzrk;

            C0991zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzka zzM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzka)) ? new C0991zza(iBinder) : (zzka) queryLocalInterface;
        }

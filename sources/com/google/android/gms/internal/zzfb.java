...
public interface zzfb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfb {
        ...
        private static class C0978zza implements zzfb {
            private IBinder zzrk;

            C0978zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzfb zzx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfb)) ? new C0978zza(iBinder) : (zzfb) queryLocalInterface;
        }

...
public class zzqc {
            ...
            this.zzIA = (String) zzqb.zzb(new Callable<String>(this) {
                ...
                public String call() {
                    ...
                    if (remoteContext != null) {
                        zzpk.m30v("Attempting to read user agent from Google Play Services.");
                        sharedPreferences = remoteContext.getSharedPreferences("admob_user_agent", 1);
                        z = false;
                    } else {
                        zzpk.m30v("Attempting to read user agent from local cache.");
                        sharedPreferences = context.getSharedPreferences("admob_user_agent", 0);
                    }
                    String string = sharedPreferences.getString("user_agent", "");
                    if (TextUtils.isEmpty(string)) {
                        zzpk.m30v("Reading user agent from WebSettings");
                        ...
                        if (z) {
                            ...
                            zzpk.m30v("Persisting user agent.");
                        }
                    }
                    return string;
                }
    ...
    public void zzab(Context context) {
        ...
        zzpk.m30v("User agent is updated.");
    }

...
public interface zzex extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzex {
        ...
        private static class C0974zza implements zzex {
            private IBinder zzrk;

            C0974zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzex zzt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzex)) ? new C0974zza(iBinder) : (zzex) queryLocalInterface;
        }

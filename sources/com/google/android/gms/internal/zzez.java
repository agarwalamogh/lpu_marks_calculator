...
public interface zzez extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzez {
        ...
        private static class C0976zza implements zzez {
            private IBinder zzrk;

            C0976zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzez zzv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzez)) ? new C0976zza(iBinder) : (zzez) queryLocalInterface;
        }

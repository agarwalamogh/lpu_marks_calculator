...
public interface zzacl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzacl {
        ...
        private static class C0954zza implements zzacl {
            private IBinder zzrk;

            C0954zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzacl zzbB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzacl)) ? new C0954zza(iBinder) : (zzacl) queryLocalInterface;
        }

...
public interface zzkd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkd {
        ...
        private static class C0994zza implements zzkd {
            private IBinder zzrk;

            C0994zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzkd zzP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkd)) ? new C0994zza(iBinder) : (zzkd) queryLocalInterface;
        }

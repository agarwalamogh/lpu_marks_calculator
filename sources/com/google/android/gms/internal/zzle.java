...
public interface zzle extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzle {
        ...
        private static class C1000zza implements zzle {
            private IBinder zzrk;

            C1000zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzle zzX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzle)) ? new C1000zza(iBinder) : (zzle) queryLocalInterface;
        }

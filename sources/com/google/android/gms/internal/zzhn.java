...
public interface zzhn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhn {
        ...
        private static class C0986zza implements zzhn {
            private IBinder zzrk;

            C0986zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhn zzG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhn)) ? new C0986zza(iBinder) : (zzhn) queryLocalInterface;
        }

...
public class zzl {
    public static boolean zza(PublicKey publicKey, String str, String str2) {
        try {
            ...
            zzpk.m31e("Signature verification failed.");
            return false;
        } catch (NoSuchAlgorithmException e) {
            zzpk.m31e("NoSuchAlgorithmException.");
            return false;
        } catch (InvalidKeyException e2) {
            zzpk.m31e("Invalid key specification.");
            return false;
        } catch (SignatureException e3) {
            zzpk.m31e("Signature exception.");
            return false;
        }
    }
    ...
    public static boolean zzb(String str, String str2, String str3) {
        ...
        zzpk.m31e("Purchase verification failed: missing data.");
        return false;
    }
}

...
public class zzd extends zzj implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    private void zzhA() {
        if (this.zzMM && zzhB() && this.zzMP.getCurrentPosition() > 0 && this.zzMO != 3) {
            zzpk.m30v("AdMediaPlayerView nudging MediaPlayer");
            zza(0.0f);
            this.zzMP.start();
    ...
    private void zzhz() {
        ...
        zzpk.m30v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzy(boolean z) {
        zzpk.m30v("AdMediaPlayerView release");
        if (this.zzMW != null) {
            this.zzMW.zzil();
            this.zzMW = null;
        }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        zzpk.m30v("AdMediaPlayerView completion");
        zzK(5);
        zzL(5);
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzpk.m30v(new StringBuilder(String.valueOf(str).length() + 37 + String.valueOf(str2).length()).append("AdMediaPlayerView MediaPlayer info: ").append(str).append(":").append(str2).toString());
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzpk.m30v("AdMediaPlayerView prepared");
        zzK(2);
        this.zzML.zzhU();
        zzpo.zzXC.post(new Runnable() {
            public void run() {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        zzpk.m30v("AdMediaPlayerView surface created");
        zzhz();
        zzpo.zzXC.post(new Runnable() {
            public void run() {
                if (zzd.this.zzMZ != null) {
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        zzpk.m30v("AdMediaPlayerView surface destroyed");
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, final int i, final int i2) {
        boolean z = true;
        zzpk.m30v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        zzpk.m30v("AdMediaPlayerView size changed: " + i + " x " + i2);
        this.zzMR = mediaPlayer.getVideoWidth();
        this.zzMS = mediaPlayer.getVideoHeight();
    ...
    public void pause() {
        zzpk.m30v("AdMediaPlayerView pause");
    ...
    public void play() {
        zzpk.m30v("AdMediaPlayerView play");
        if (zzhB()) {
            this.zzMP.start();
            zzK(3);
            this.zzNR.zzhV();
    ...
    public void seekTo(int i) {
        zzpk.m30v("AdMediaPlayerView seek " + i);
        if (zzhB()) {
            this.zzMP.seekTo(i);
            this.zzMY = 0;
            return;
    ...
    public void stop() {
        zzpk.m30v("AdMediaPlayerView stop");
        if (this.zzMP != null) {
            this.zzMP.stop();
            this.zzMP.release();
            this.zzMP = null;

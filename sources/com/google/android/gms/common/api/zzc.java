...
public abstract class zzc<O extends ApiOptions> {
    ...
    public static class zza {
        public static final zza zzayY = new C0932zza().zzvk();
        ...
        public static class C0932zza {
            private zzabs zzayW;
            private Looper zzrs;

            public C0932zza zza(zzabs zzabs) {
                zzac.zzb(zzabs, (Object) "StatusExceptionMapper must not be null.");
                this.zzayW = zzabs;
                return this;
            }

            public C0932zza zzb(Looper looper) {
    ...
    public zzc(@NonNull Activity activity, Api<O> api, O o, Looper looper, zzabs zzabs) {
        this(activity, api, o, new C0932zza().zzb(looper).zza(zzabs).zzvk());
    }
    ...
    public zzc(@NonNull Activity activity, Api<O> api, O o, zzabs zzabs) {
        this(activity, api, o, new C0932zza().zza(zzabs).zzb(activity.getMainLooper()).zzvk());
    }
    ...
    public zzc(@NonNull Context context, Api<O> api, O o, Looper looper, zzabs zzabs) {
        this(context, api, o, new C0932zza().zzb(looper).zza(zzabs).zzvk());
    }
    ...
    public zzc(@NonNull Context context, Api<O> api, O o, zzabs zzabs) {
        this(context, api, o, new C0932zza().zza(zzabs).zzvk());
    }

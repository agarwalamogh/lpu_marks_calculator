...
public interface zzx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzx {
        ...
        private static class C0940zza implements zzx {
            private IBinder zzrk;

            C0940zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzx zzbw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzx)) ? new C0940zza(iBinder) : (zzx) queryLocalInterface;
        }

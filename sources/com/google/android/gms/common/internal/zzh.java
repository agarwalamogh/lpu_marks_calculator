...
public final class zzh {
    ...
    public static String zzg(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0391R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C0391R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C0391R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    public static String zzh(Context context, int i) {
        String zzg = i == 6 ? zzB(context, "common_google_play_services_resolution_required_title") : zzg(context, i);
        return zzg == null ? context.getResources().getString(C0391R.string.common_google_play_services_notification_ticker) : zzg;
    }
    ...
    public static String zzi(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0391R.string.common_google_play_services_install_text, new Object[]{zzaT});
            case 2:
                if (zzj.zzba(context)) {
                    return resources.getString(C0391R.string.common_google_play_services_wear_update_text);
                }
                return resources.getString(C0391R.string.common_google_play_services_update_text, new Object[]{zzaT});
            case 3:
                return resources.getString(C0391R.string.common_google_play_services_enable_text, new Object[]{zzaT});
            case 5:
            ...
            case 9:
                return resources.getString(C0391R.string.common_google_play_services_unsupported_text, new Object[]{zzaT});
            case 16:
            ...
            case 18:
                return resources.getString(C0391R.string.common_google_play_services_updating_text, new Object[]{zzaT});
            case 20:
                return zzo(context, "common_google_play_services_restricted_profile_text", zzaT);
            default:
                return resources.getString(C0391R.string.common_google_play_services_unknown_issue, new Object[]{zzaT});
        }
    }
    ...
    public static String zzk(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0391R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0391R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0391R.string.common_google_play_services_enable_button);
            default:
    ...
    private static String zzo(Context context, String str, String str2) {
        ...
        if (zzB == null) {
            zzB = resources.getString(C0391R.string.common_google_play_services_unknown_issue);
        }

...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C0935zza implements zzr {
            private IBinder zzrk;

            C0935zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzr zzbr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C0935zza(iBinder) : (zzr) queryLocalInterface;
        }

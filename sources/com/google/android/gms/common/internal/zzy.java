...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        private static class C0941zza implements zzy {
            private IBinder zzrk;

            C0941zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzy zzbx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C0941zza(iBinder) : (zzy) queryLocalInterface;
        }

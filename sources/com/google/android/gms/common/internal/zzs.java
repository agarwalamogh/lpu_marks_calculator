...
public interface zzs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzs {
        ...
        private static class C0936zza implements zzs {
            private IBinder zzrk;

            C0936zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzs zzbs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzs)) ? new C0936zza(iBinder) : (zzs) queryLocalInterface;
        }

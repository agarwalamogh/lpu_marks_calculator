...
public interface zzw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzw {
        ...
        private static class C0939zza implements zzw {
            private IBinder zzrk;

            C0939zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzw zzbv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzw)) ? new C0939zza(iBinder) : (zzw) queryLocalInterface;
        }

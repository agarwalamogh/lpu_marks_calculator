...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        private static class C0938zza implements zzv {
            private final IBinder zzrk;

            C0938zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzv zzbu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzv)) ? new C0938zza(iBinder) : (zzv) queryLocalInterface;
        }

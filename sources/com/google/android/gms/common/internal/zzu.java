...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C0937zza implements zzu {
            private IBinder zzrk;

            C0937zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzu zzbt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C0937zza(iBinder) : (zzu) queryLocalInterface;
        }
